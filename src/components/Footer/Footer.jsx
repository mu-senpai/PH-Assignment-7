                ...
                <div className="w-[95%] sm:w-[90%] lg:w-[81.25%] grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0">
                    ...
                    <div className="w-full space-y-4">
                        ...
                        <div className="join w-full">
                            <input className="input w-full md:w-[70%] input-bordered join-item" placeholder="Email" />
                            <button className="btn join-item rounded-r-xl bg-gradient-to-r from-[#a894cd] to-[#f7c951] border-none">Subscribe</button>
                        </div>
                    </div>
                </div>
